...
onready var spike_position := $IceSpikePosition
...
func _fire_projectile() -> void:
	...
	if not GameState.online_play:
		_do_fire_projectile(projectile_name, spike_position.global_position, projectile_vector, projectile_range)
	else:
		OnlineMatch.custom_rpc_sync(self, "_do_fire_projectile", [projectile_name, spike_position.global_position, projectile_vector, projectile_range])
